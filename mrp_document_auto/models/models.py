...
#                     already_exists = Attachment.search_count([
#                         ('res_model', '=', 'product.template'),
...
#                         # Mettre à jour le document associé pour forcer attached_on = inside
...
#                 # Lancer la synchro
#                 for bom in boms:
#                     bom._copy_attachments_to_product_template()
